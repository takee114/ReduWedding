...
export default function ServicesPage() {
  const services = [
    {
      ...
      longDescription:
        "Our SEO experts use proven techniques to improve your website's search engine rankings and drive qualified organic traffic to your business.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Create compelling social media campaigns that drive engagement, build brand awareness, and generate leads across Facebook, Instagram, LinkedIn, and Twitter.",
      features: [
    ...
    },
    {
      ...
      description:
        "Drive immediate traffic and conversions with targeted advertising campaigns.",
      longDescription:
        "Maximize your advertising ROI with expertly managed PPC campaigns across Google Ads, Facebook Ads, and other major advertising platforms.",
      features: [
    ...
    },
    {
      ...
      description:
        "Make data-driven decisions with comprehensive analytics and performance tracking.",
      longDescription:
        "Get deep insights into your digital marketing performance with custom dashboards, detailed reports, and actionable recommendations.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Develop a comprehensive content strategy that positions your brand as an industry leader and drives qualified leads to your business.",
      features: [
    ...
    },
    {
      ...
      description:
        "Maximize your website's potential by optimizing user experience and conversion funnels.",
      longDescription:
        "Increase your website's conversion rates through systematic testing, user experience improvements, and funnel optimization.",
      features: [
  ...
  const packages = [
    ...
    },
    {
      ...
      period: "/month",
      description:
        "Ideal for growing businesses ready to scale their digital marketing",
      features: [
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="font-extrabold text-4xl lg:text-6xl text-gray-900 leading-tight mb-6">
            ...
            <span className="relative inline-block ml-4">Services</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 flex flex-col"
              >
                {/* Icon and title */}
                <div className="flex items-start space-x-4 mb-6">
                  <div className="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 flex-shrink-0 shadow-inner">
                    {service.icon}
                  </div>
                  <div>
                ...
                {/* Pricing and results + CTA */}
                <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              include dedicated support and monthly performance reporting.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <div
                key={index}
                className={`bg-white rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 relative flex flex-col ${
                  pkg.popular
              ...
              >
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-blue-500 text-white px-4 py-1 rounded-full text-sm font-medium shadow-md">
                      Most Popular
                    </span>
                  </div>
                )}
